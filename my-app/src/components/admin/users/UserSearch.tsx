...
/**
 * Debounced search over name + email. The manager remounts this (via key)
 * when it clears the query externally, so no prop-to-state sync is needed.
 */
export function UserSearch({ value, onChange }: { value: string; onChange: (q: string) => void }) {
